...
const rules = [
  ...
  [/^each player (?:discards their hand, then draws seven cards|shuffles their hand and graveyard into their library, then draws seven cards)$/, () => [{ type: 'discard', all: true, sel: 'each', restrict: { players: 'all' } }, { type: 'draw', amount: 7, sel: 'each', restrict: { players: 'all' } }]],
