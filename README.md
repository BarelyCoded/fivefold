...
Spend them at a city's **amulet exchange**, a browsable shop of that city's colour plus colourless artifacts. Every playable card in the Alpha-to-Alliances pool is stocked (a bundled catalogue, its data fetched from Scryfall the first time you open a city), and each card's price in amulets scales with its rarity and mana value, so a rare bomb costs several amulets and a common one. Coloured cards cost amulets of the city's colour; artifacts take amulets of any colour. You can also trade at a **Diamond Mine** (any amulet for a random card of its colour) or cast **world magic**: with a red amulet in hand the map offers the Staff of Thunder, which scatters every monster within three tiles. The Gem Cutter Guild, the Lost City and the Diamond Mines are special lairs marked as gems on the map and minimap. Amulet state lives in the save alongside gold and food.
